...
const AllBlog = (props) => {
    ...
    const [blogId, setBlogId] = (0, react_1.useState)("");
    const { isLoading, data, refetch } = (0, blogsApi_1.useGetAllBlogQuery)({}, { refetchOnMountOrArgChange: true });
    const [deleteBlog, { isSuccess, error, isLoading: isLoadingDel }] = (0, blogsApi_1.useDeleteBlogMutation)({});
    ...
    const columns = [
        ...
        { field: "created_at", headerName: "Created At", flex: 0.5 },
        {
            ...
            renderCell: (params) => {
                return (<>
                        <link_1.default href={`/admin/edit-blog/${params.row.id}`}>
    ...
    (0, react_1.useEffect)(() => {
        if (isSuccess) {
            setOpen(false);
            refetch();
            react_hot_toast_1.toast.success("Blog Deleted Successfully");
        }
        if (error) {
            if ("data" in error) {
