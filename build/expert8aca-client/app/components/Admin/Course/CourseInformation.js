      ...
      <form onSubmit={handleSubmit} className={`${style_1.styles.label}`}>
        ...
        <div className="w-full flex justify-between">
          <div className="w-[45%]">
            ...
            <select name="" id="" className={`${style_1.styles.input}`} value={courseInfo.status} onChange={(e) => setCourseInfo({ ...courseInfo, status: e.target.value })}>
              <option value={'Public'}>
                🌎 {'Public'}
              </option>
          ...
          <div className="w-[50%] relative">
            ...
            <input type="number" name="" value={courseInfo.limitWatchedTime} onChange={(e) => setCourseInfo({ ...courseInfo, limitWatchedTime: e.target.value })} id="limitTime" placeholder="1000" className={` ${style_1.styles.input} relative`}>
            </input>
