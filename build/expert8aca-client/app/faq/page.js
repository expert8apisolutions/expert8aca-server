...
const Page = (props) => {
    ...
    const [activeItem, setActiveItem] = (0, react_1.useState)(6);
    const [route, setRoute] = (0, react_1.useState)("Login");
    return (<div className="min-h-screen">
      <Heading_1.default title="FAQ - Elearning" description="Elearning is a learning management system for helping programmers." keywords="programming,mern"/>
