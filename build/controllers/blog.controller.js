...
exports.generateVideoUrl = exports.deleteBlog = exports.getAdminAllCourses = exports.addReplyToReview = exports.addReview = exports.addAnwser = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = exports.editBlog = exports.getAllBlog = exports.getBlogMeta = exports.getBlogContentById = exports.getBlogContent = exports.createBlog = void 0;
...
exports.createBlog = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const result = await blog_model_1.default.create({ ...data });
        res.status(201).json({
            success: true,
            result,
        });
...
exports.getBlogContent = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const slug = req.params.slug;
        const result = await blog_model_1.default.findOne({ slug });
        res.status(201).json({
            success: true,
            result,
        });
...
exports.getBlogContentById = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const id = req.params.id;
        const result = await blog_model_1.default.findById(id);
        res.status(201).json({
            success: true,
            result,
        });
...
exports.getBlogMeta = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const slug = req.params.slug;
        const result = await blog_model_1.default.findOne({ slug }).select('-content');
        res.status(201).json({
            success: true,
            result,
        });
...
exports.getAllBlog = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const result = await blog_model_1.default.find({}).select('-content');
        res.status(201).json({
            success: true,
            result,
        });
